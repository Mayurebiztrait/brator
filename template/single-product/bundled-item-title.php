...
?><h4 class="bundled_product_title product_title">dddddddddd <?php
		$title = '<span class="bundled_product_title_inner">' . WC_PB_Helpers::format_product_shop_title( $title, $quantity, '', $title_suffix ). '</span></br><span> SKU: '. $product_for_sku->get_sku().'</span></br><span class="stock_status">'. $product_for_sku->get_stock_status().'</span>';
